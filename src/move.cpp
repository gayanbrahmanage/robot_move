...
//----------------------------------------------------------------------
void pathCallback(trajectory_planner::h20path msg)
 {
	pathx=msg.x[2];
	ROS_INFO("path=> X: [%f]", pathx);
 }
//----------------------------------------------------------------------
...
int main(int argc, char **argv)
{
	   ...
	   robotodometry_sub = n.subscribe("odom", 1000, odomCallback);
	   path_sub = n.subscribe("h20path", 1000, pathCallback);
